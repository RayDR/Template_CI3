                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            <div>
                                ...
                                <textarea class="form-control" placeholder="Descripción del preproyecto o propuesta." id="detalle_preproyecto" name="detalle_preproyecto" rows="4" required><?= $preproyecto->actividad ?></textarea>
                            </div>
                        </div>
                    </div>
