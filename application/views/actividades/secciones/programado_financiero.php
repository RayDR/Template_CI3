    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            <div>
                ...
                <input id="financiero_objetivo_anual" name="financiero_objetivo_anual "type="number" class="form-control objetivos" data-tipo="financiero" value="0" min="0" required>
            </div>
        </div>
    </div>
